...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemList.add(new Item(1, "poor_things", "poor things",  "The film explores themes of identity, power, and morality in a darkly humorous and surreal manner. Starring Emma Stone, Mark Ruffalo, and Willem Dafoe, \"Poor Things\" promises to be a thought-provoking and visually captivating cinematic experience.", "#E0E07B", "harry styles", 1));
        itemList.add(new Item(2, "interstellar", "interstellar", "\"The film explores themes of love, sacrifice, and the resilience of the human spirit. With stunning visuals, an emotional and thought-provoking narrative \"Interstellar\" is a cinematic journey through space and time that will leave audiences in awe.", "#F3AE82", "olivia rodrigo", 2));
        itemList.add(new Item(3, "parasite", "parasite",  "The film delves into themes of social class, inequality, and the consequences of greed. \"Parasite\" received critical acclaim for its sharp storytelling, strong performances, and social commentary, ultimately winning the Palme d'Or at the Cannes Film Festival.", "#BBBB9B", "one direction", 3));
        itemList.add(new Item(4, "spider_man", "spider man:\nbeyond the spider verse",  "Miles Morales navigates the multiverse with different Spider-Men. Unique animation style and thrilling action sequences make \"Across the Spider-Verse\" is a visually stunning addition to the Spider-Man franchise.", "#E32636", "1d", 4));
